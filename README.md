...
- Ability to provide a date and venue pair to get links to correct shows on setlist.fm
- Ability to view the collected list of shows by date, venue, or band
- Ability to pull metrics from attended shows like shows/bands/songs in a year, etc
- Ability to edit or add shows/bands/venues/songs manually
- Automatic normalizing of data to source(s); band name, venue name, maybe others (not song name)
- Ability to submit a full list of date/venue pairs and have lists of concert entries generated automatically
...
- Venue: The place a show takes place. Data for a venue would include
    ...
    - City
    - State
- Artist: One of the bands/solo performers performing a set of songs at a show. Data for an artist would include
    - Name
    - Notes
- Song: One of the musical performances done during a set by an artist. Data for a song would include
    - Name
    - Artist
    - Notes
...
- Show Setlist: All of the Songs performed by all Artists at a Show in order of Performance
